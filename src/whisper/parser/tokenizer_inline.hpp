#ifndef WHISPER__PARSER__TOKENIZER_INLINE_HPP
#define WHISPER__PARSER__TOKENIZER_INLINE_HPP
...
Tokenizer::readInputElementImpl(InputElementKind iek)
{
    ...
    // Whitespace and simple identifiers will be very common.
...
#endif // WHISPER__PARSER__TOKENIZER_INLINE_HPP
