...
PREDECLARE_FIXSIZED_HEAP_OBJ_(ReturnStmtSyntaxFrame);
PREDECLARE_FIXSIZED_HEAP_OBJ_(VarSyntaxFrame);
...
PREDECLARE_FIXSIZED_HEAP_OBJ_(DotExprSyntaxFrame);
PREDECLARE_FIXSIZED_HEAP_OBJ_(NativeCallResumeFrame);

PREDECLARE_FIXSIZED_HEAP_OBJ_(Continuation);
PREDECLARE_FIXSIZED_HEAP_OBJ_(ContObject);
